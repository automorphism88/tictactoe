...
tictactoe: $(OBJECTS)
	$(CC) $(CFLAGS) -Wall $(OBJECTS) -o tictactoe $(LDFLAGS)

obj/main.o: src/main.c src/cli.h src/tictactoe.h
	@ mkdir -p obj
	$(CC) $(CFLAGS) -Wall -c src/main.c -o obj/main.o

obj/cli.o: src/cli.c src/cli.h src/tictactoe.h
	@ mkdir -p obj
	$(CC) $(CFLAGS) -Wall -c src/cli.c -o obj/cli.o

obj/tictactoe.o: src/tictactoe.c src/tictactoe.h
	@ mkdir -p obj
	$(CC) $(CFLAGS) -Wall -c src/tictactoe.c -o obj/tictactoe.o
